...
export const MultiSelect = React.forwardRef<HTMLButtonElement, MultiSelectProps>(
  (
    ...
    const allSelected = filteredOptions.every((option) => selectedSet.has(option.value));

    const toggleAll = () => {
      if (!allSelected || selectedSet.size > filteredOptions.length) {
        ...
        >
          <Command className="pointer-events-auto" shouldFilter={false}>
            ...
            <CommandList>
              ...
              <CommandGroup>
                <CommandItem key="all" className="cursor-pointer" value="all" onSelect={toggleAll}>
                  <div
                    className={cn(
                  ...
                  <span>(Select All - {filteredOptions.length})</span>
                </CommandItem>
              ...
              <CommandGroup className="sticky bottom-0 bg-background">
                <div className="flex items-center justify-between sticky bottom-0">
                  {selectedValues.length > 0 && (
                    <>
                      <CommandItem
